...
%% compute guass based signal curve
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%fig 2%
%parameterNovelty = [];
...
guass_signal = generateSignal_amp(audio, Fs, onsetTime, 4000);
guass_signal = guass_signal.';
...
%visualize_noveltyCurve(guass_signal,parameterVis)
%title('Signal curve')
...
[tempogram_fourier, T, BPM] = noveltyCurve_to_tempogram_via_DFT(guass_signal,parameterTempogram);
...
[tempogram_autocorrelation_timeLag, T, timeLag] = noveltyCurve_to_tempogram_via_ACF(guass_signal,parameterTempogram);
...
title('Fourier X Autocorrelation')
